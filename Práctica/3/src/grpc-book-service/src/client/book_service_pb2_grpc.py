...
class BookServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListBooks = channel.unary_unary(
                ...
                request_serializer=book__service__pb2.ListBooksRequest.SerializeToString,
                response_deserializer=book__service__pb2.ListBooksResponse.FromString,
                _registered_method=True)
...
def add_BookServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListBooks': grpc.unary_unary_rpc_method_handler(
                    servicer.ListBooks,
                    request_deserializer=book__service__pb2.ListBooksRequest.FromString,
                    response_serializer=book__service__pb2.ListBooksResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'app.pdytr.BookService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('app.pdytr.BookService', rpc_method_handlers)
...
class BookService(object):
    ...
    def ListBooks(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/app.pdytr.BookService/ListBooks',
            book__service__pb2.ListBooksRequest.SerializeToString,
            book__service__pb2.ListBooksResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
